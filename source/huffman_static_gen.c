...
static struct aws_huffman_bit_pattern code_points[] = {
    ...
    { .pattern = 0x0, .num_bits = 5 }, /* 48 */
    { .pattern = 0x1, .num_bits = 5 }, /* 49 */
    { .pattern = 0x2, .num_bits = 5 }, /* 50 */
    { .pattern = 0x19, .num_bits = 6 }, /* 51 */
    { .pattern = 0x1a, .num_bits = 6 }, /* 52 */
    { .pattern = 0x1b, .num_bits = 6 }, /* 53 */
    { .pattern = 0x1c, .num_bits = 6 }, /* 54 */
    { .pattern = 0x1d, .num_bits = 6 }, /* 55 */
    { .pattern = 0x1e, .num_bits = 6 }, /* 56 */
    { .pattern = 0x1f, .num_bits = 6 }, /* 57 */
    ...
    { .pattern = 0x21, .num_bits = 6 }, /* 65 */
    { .pattern = 0x5d, .num_bits = 7 }, /* 66 */
    { .pattern = 0x5e, .num_bits = 7 }, /* 67 */
    { .pattern = 0x5f, .num_bits = 7 }, /* 68 */
    { .pattern = 0x60, .num_bits = 7 }, /* 69 */
    { .pattern = 0x61, .num_bits = 7 }, /* 70 */
    { .pattern = 0x62, .num_bits = 7 }, /* 71 */
    { .pattern = 0x63, .num_bits = 7 }, /* 72 */
    { .pattern = 0x64, .num_bits = 7 }, /* 73 */
    { .pattern = 0x65, .num_bits = 7 }, /* 74 */
    { .pattern = 0x66, .num_bits = 7 }, /* 75 */
    { .pattern = 0x67, .num_bits = 7 }, /* 76 */
    { .pattern = 0x68, .num_bits = 7 }, /* 77 */
    { .pattern = 0x69, .num_bits = 7 }, /* 78 */
    { .pattern = 0x6a, .num_bits = 7 }, /* 79 */
    { .pattern = 0x6b, .num_bits = 7 }, /* 80 */
    { .pattern = 0x6c, .num_bits = 7 }, /* 81 */
    { .pattern = 0x6d, .num_bits = 7 }, /* 82 */
    { .pattern = 0x6e, .num_bits = 7 }, /* 83 */
    { .pattern = 0x6f, .num_bits = 7 }, /* 84 */
    { .pattern = 0x70, .num_bits = 7 }, /* 85 */
    { .pattern = 0x71, .num_bits = 7 }, /* 86 */
    { .pattern = 0x72, .num_bits = 7 }, /* 87 */
    { .pattern = 0xfc, .num_bits = 8 }, /* 88 */
    { .pattern = 0x73, .num_bits = 7 }, /* 89 */
    { .pattern = 0xfd, .num_bits = 8 }, /* 90 */
    { .pattern = 0x1ffb, .num_bits = 13 }, /* 91 */
    { .pattern = 0x7fff0, .num_bits = 19 }, /* 92 */
    { .pattern = 0x1ffc, .num_bits = 13 }, /* 93 */
    { .pattern = 0x3ffc, .num_bits = 14 }, /* 94 */
    { .pattern = 0x22, .num_bits = 6 }, /* 95 */
    { .pattern = 0x7ffd, .num_bits = 15 }, /* 96 */
    { .pattern = 0x3, .num_bits = 5 }, /* 97 */
    { .pattern = 0x23, .num_bits = 6 }, /* 98 */
    { .pattern = 0x4, .num_bits = 5 }, /* 99 */
    { .pattern = 0x24, .num_bits = 6 }, /* 100 */
    { .pattern = 0x5, .num_bits = 5 }, /* 101 */
    { .pattern = 0x25, .num_bits = 6 }, /* 102 */
    { .pattern = 0x26, .num_bits = 6 }, /* 103 */
    { .pattern = 0x27, .num_bits = 6 }, /* 104 */
    { .pattern = 0x6, .num_bits = 5 }, /* 105 */
    { .pattern = 0x74, .num_bits = 7 }, /* 106 */
    { .pattern = 0x75, .num_bits = 7 }, /* 107 */
    { .pattern = 0x28, .num_bits = 6 }, /* 108 */
    { .pattern = 0x29, .num_bits = 6 }, /* 109 */
    { .pattern = 0x2a, .num_bits = 6 }, /* 110 */
    { .pattern = 0x7, .num_bits = 5 }, /* 111 */
    { .pattern = 0x2b, .num_bits = 6 }, /* 112 */
    { .pattern = 0x76, .num_bits = 7 }, /* 113 */
    { .pattern = 0x2c, .num_bits = 6 }, /* 114 */
    { .pattern = 0x8, .num_bits = 5 }, /* 115 */
    { .pattern = 0x9, .num_bits = 5 }, /* 116 */
    { .pattern = 0x2d, .num_bits = 6 }, /* 117 */
    { .pattern = 0x77, .num_bits = 7 }, /* 118 */
    { .pattern = 0x78, .num_bits = 7 }, /* 119 */
    { .pattern = 0x79, .num_bits = 7 }, /* 120 */
    { .pattern = 0x7a, .num_bits = 7 }, /* 121 */
    { .pattern = 0x7b, .num_bits = 7 }, /* 122 */
    ...
    { .pattern = 0x3fffffff, .num_bits = 30 }, /* 256 */
};
